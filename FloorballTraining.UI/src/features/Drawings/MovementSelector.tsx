                ...
                >
                    <svg width={32} height={32}>
                        {tool.toolId === 'run-free' && (
                            ...
                            <path d="m3 28c15-4-1-10 10-12s-2-4 12-7" stroke={tool.stroke} strokeWidth={tool.strokeWidth} strokeDasharray={RUN_STROKE_DASH_ICON} fill="none" markerEnd={`url(#arrow-${tool.stroke.replace('#', '')})`}  />
                            )}
                        {tool.toolId === 'run-straight' && (
                            <path d="M3,28 Q16,16 24,8" stroke={tool.stroke} strokeWidth={tool.strokeWidth} strokeDasharray={RUN_STROKE_DASH_ICON} fill="none" markerEnd={`url(#arrow-${tool.stroke.replace('#', '')})`} />
                        )}

                        {tool.toolId === 'shoot' && (
                            <g>
                            <path d="M5,28 Q17,15 25,7" stroke={tool.stroke} strokeWidth={tool.strokeWidth} strokeDasharray={tool.strokeDasharray} fill="none"  />
                            <path d="M6,29 Q18,16 26,8" stroke={''} strokeWidth={tool.strokeWidth} strokeDasharray={tool.strokeDasharray} fill="none" markerEnd={`url(#arrow-${tool.stroke.replace('#', '')})`} />
                            <path d="M7,30 Q19,17 27,9" stroke={tool.stroke} strokeWidth={tool.strokeWidth} strokeDasharray={tool.strokeDasharray} fill="none" />
                            </g>
                        )}
