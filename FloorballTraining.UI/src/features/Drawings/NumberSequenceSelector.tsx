...
const NumberSequenceSelector: React.FC<Props> = ({
  ...
  return (
    <div className="tool-group">
      ...
      <div className="tool-item" style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
        ...
        <input
          ...
          style={{ width: 60 }}
        />
        <button onClick={applyStart} style={{ fontSize: 10, padding: '2px 4px', marginTop: 4 }}>Set</button>
      </div>
    </div>
  );
};
