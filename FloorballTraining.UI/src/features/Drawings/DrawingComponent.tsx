            ...
            <div id="container">
                <div id="drawing-area">
                    <svg
                        ...
                        viewBox={`0 0 ${selectedField.width} ${selectedField.height}`}
                        onMouseDown={handleCanvasMouseDown}
                        onMouseMove={handleCanvasMouseMove}
                        onMouseUp={handleCanvasMouseUp}
                    >
                        <g id="field-layer">
                            {selectedField.svgMarkup && (
                                <g dangerouslySetInnerHTML={{ __html: selectedField.svgMarkup }} />
                            )}
                        </g>
                        <g id="content-layer">
                            {lines.map((line, idx) => (
