...
public class ActivitiesSpecification : BaseSpecification<Activity>
{
    public ActivitiesSpecification(ActivitySpecificationParameters parameters, object? env = null) : base(
        x =>
            ...
            (string.IsNullOrEmpty(parameters.Tag) || x.ActivityTags.Any(t => t.Tag != null
                && parameters.Tag.Split(";", StringSplitOptions.TrimEntries).Any(tt => t.Tag.Name.ToLower().Contains(tt.ToLower()))))
...
public class ActivitiesBaseSpecification : BaseSpecification<Activity>
{
    ...
    public ActivitiesBaseSpecification(ActivityBaseSpecificationParameters parameters, object? env = null) : base(
        x =>
...
{
    public ActivitiesBaseForCountSpecification(ActivityBaseSpecificationParameters parameters, object? env = null) : base(
        x =>
    ...
    public ActivitiesBaseForCountSpecification(ActivitySpecificationParameters parameters, object? env = null) : base(
        x =>
