...
public class TestSkillGradeRangeConfiguration : IEntityTypeConfiguration<TestSkillGradeRange>
{
    public void Configure(EntityTypeBuilder<TestSkillGradeRange> builder)
    {
        builder.Property(p => p.Id).IsRequired();
        builder.Property(p => p.TestDefinitionId).IsRequired();

        builder.HasOne(c => c.TestDefinition)
            .WithMany(t => t.SkillGradeRanges)
