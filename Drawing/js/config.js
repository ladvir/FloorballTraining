...
export const fieldOptions = [
    {
        id: 'none',
        label: 'No Field',
        svgMarkup: '' // Empty string for no background
    },
    {
        id: 'half-rink',
        label: 'Half Rink',
        // Adjusted viewBox and potentially simplified for background use
...
// ... (playerTools, equipmentTools, movementTools, passShotTools, numberTools, textTools remain the same) ...
...
const movementTools = [ { category: 'movement', toolId: 'run-straight', label: 'Run Straight', type: 'arrow', stroke: 'blue', strokeWidth: ARROW_STROKE_WIDTH_RUN, strokeDasharray: ARROW_DASH_RUN, markerEndId: MARKER_ARROW_RUN_ID }, { category: 'movement', toolId: 'run-free', label: 'Run Free', type: 'arrow', stroke: 'blue', strokeWidth: ARROW_STROKE_WIDTH_RUN, strokeDasharray: ARROW_DASH_RUN, markerEndId: MARKER_ARROW_RUN_ID } ];
const passShotTools = [ { category: 'passShot', toolId: 'pass', label: 'Pass', type: 'arrow', stroke: 'black', strokeWidth: ARROW_STROKE_WIDTH_PASS, markerEndId: MARKER_ARROW_PASS_ID }, { category: 'passShot', toolId: 'shot', label: 'Shot', type: 'arrow', stroke: 'red', strokeWidth: ARROW_STROKE_WIDTH_SHOT, markerEndId: MARKER_ARROW_SHOT_ID, isDoubleLine: true } ];
