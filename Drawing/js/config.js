...
export const FREEHAND_SIMPLIFICATION_TOLERANCE = 1.5; // Tolerance for simplifying freehand path
...
const movementTools = [
    ...
    // **** Update run-free type ****
    { category: 'movement', toolId: 'run-free', label: 'Run Free', type: 'freehand-arrow', stroke: 'blue', strokeWidth: ARROW_STROKE_WIDTH_RUN, strokeDasharray: ARROW_DASH_RUN, markerEndId: MARKER_ARROW_RUN_ID }
];
