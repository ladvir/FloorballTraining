                ...
                {items.map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <button
                        type="button"
                        onClick={() => setPreviewId(item.trainingId)}
          ...
          <div>
            ...
            <ul className="max-h-44 space-y-1 overflow-y-auto">
              {available.map((training) => (
                <li key={training.id} className="flex items-center gap-1">
                  <button
                    type="button"
                    onClick={() => add(training.id)}
                    className="flex min-w-0 flex-1 items-center gap-2 rounded-lg px-2 py-1.5 text-left text-sm hover:bg-sky-50"
                  >
                  ...
                  <button
                    type="button"
                    onClick={() => setPreviewId(training.id)}
                    title={t('planning.preview')}
                    aria-label={t('planning.preview')}
