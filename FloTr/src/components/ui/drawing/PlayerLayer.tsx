      ...
      return (
              ...
              <g transform="scale(0.74)">
                <g>
                  <path
                    ...
                    d="M46.004,21.672c5.975,0,10.836-4.861,10.836-10.836S51.979,0,46.004,0c-5.975,0-10.835,4.861-10.835,10.836
		S40.029,21.672,46.004,21.672z"
                  ...
                  <path
                    ...
                    strokeWidth={player.tool.strokeWidth}
                    fill={player.tool.fill}
                    d="M68.074,54.008L59.296,26.81c-0.47-1.456-2.036-2.596-3.566-2.596h-1.312H53.48H38.526h-0.938h-1.312
		...
		c0.848,0,1.591-0.354,2.041-0.971S68.334,54.815,68.074,54.008z"
            ...
            {(player.tool.type === 'playerB' ||
              player.tool.type === 'coach' ||
              player.tool.type === 'opponent') && (
              <circle
                r={player.tool.radius ?? 6}
                fill={player.tool.fill}
                stroke={player.tool.stroke}
                strokeWidth={player.tool.strokeWidth}
              />
            ...
            {player.tool.toolId === 'opponent' && (
              <g>
                <line
                  x1={-player.tool.radius / 2}
                  y1={-player.tool.radius / 2}
                  x2={player.tool.radius / 2}
                  y2={player.tool.radius / 2}
                  stroke={player.tool.stroke}
                  strokeWidth={player.tool.strokeWidth}
                />
                <line
            ...
            {player.tool.text && (
              <text x={0} y={5} textAnchor="middle" fontSize={13} fill={player.tool.textColor}>
                {player.tool.text}
              </text>
            )}
          </g>
