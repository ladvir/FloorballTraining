                ...
                <ToolDropdown
                    ...
                    icon={
                        <svg width={32} height={32}>
                            ...
                            {(activePlayerTool?.type === "playerB" || activePlayerTool?.type === "coach") && (
                                <>
                                    <circle
                                        cx={16}
                                        cy={16}
                                        r={activePlayerTool.radius - 2}
                                        fill={activePlayerTool.fill}
                                        stroke={activePlayerTool.stroke}
                                        strokeWidth={activePlayerTool.strokeWidth}
                                    />
                                    {activePlayerTool?.text && (
                                        <text
                                            x={16}
                                            y={21}
                                            textAnchor="middle"
                                            fontSize={14}
                                            fill={activePlayerTool.textColor}
                                        >
                                            {activePlayerTool.text}
                                        </text>
                                    )}
