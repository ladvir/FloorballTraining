...
const DeleteSelectionSelectorNumbers: React.FC<DeleteSelectionSelectorNumbersProps> = ({
  hasSelection,
  onDeleteSelected,
}) => {
  ...
  return (
    <div className="tool-group">
      <div className="tool-item">
        ...
        <span>{t('drawing.deleteSelected')}</span>
      </div>
    </div>
  )
}

export default DeleteSelectionSelectorNumbers
