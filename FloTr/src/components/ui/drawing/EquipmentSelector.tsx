...
const equipmentLabelKeys: Record<string, string> = {
  ball: 'drawing.equipmentBall',
  gate: 'drawing.equipmentGate',
  'low-cone': 'drawing.equipmentCone',
  'slalom-pole': 'drawing.equipmentPole',
  ladder: 'drawing.equipmentLadder',
}
  ...
  return (
    <div className="tool-group-inline">
      {equipmentTools.map((tool) => {
        const label = t(equipmentLabelKeys[tool.toolId] ?? 'drawing.toolEquipment')
        return (
              ...
              {tool.toolId === 'ball' || false ? (
                ...
                <svg width={32} height={32}>
                  <g>
                    <path
                      fill="#D68847"
                      d="M25.38 32H6.62c-.94 0-1.66-.72-1.66-1.66s.72-1.66 1.66-1.66h18.76c.94 0 1.66.72 1.66 1.66S26.32 32 25.38 32"
                    />
                    <g fill="#ECBA16">
