...
{
    /// <summary>
    /// Career ranks (Czech domain terms) with their lifetime-XP floor, ascending. Never resets.
    /// Widened 2026-08-14 from 7 to 14 tiers so an engaged player (~1500-2500 XP/season, from
    /// XpRules) has a fresh rank roughly every season across a 10-season career instead of maxing
    /// out at "Legenda" by season 3-4; "Nesmrtelný" is the open-ended top for multi-decade veterans.
    /// </summary>
